...
function createBox() {
  ...
  scene.add(cube);
  cube.scale.x = 5; // SCALE
  cube.scale.y = 35; // SCALE
  cube.scale.z = 55; // SCALE
...
function getScene() {
  var scene = new THREE.Scene();
  scene.background = new THREE.Color(7601534);//
  return scene;
}
...
function loadModel() {
  ...
  loader.load('Objects/Watchout.obj', function (object) {
